...
const STATUS_LABEL = {
    ...
    accepted: '✅ Aceita — investigação a abrir',
    rejected: '❌ Arquivada',
};
...
function buildReviewEmbed(complaint) {
    const embed = new EmbedBuilder()
        ...
        .addFields(
            ...
            {
                name: 'Denunciante',
                value: complaint.is_anonymous
                    ? '🕵️ Anônima'
                    : `<@${complaint.complainant_discord_id}>${complaint.complainant_name ? ` (${complaint.complainant_name})` : ''}`,
                inline: true,
            },
