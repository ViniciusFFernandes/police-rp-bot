...
function buildReviewEmbed(complaint) {
    const embed = new EmbedBuilder()
        ...
        .addFields(
            ...
            { name: 'Denunciante', value: complaint.is_anonymous ? '🕵️ Anônimo' : `<@${complaint.complainant_discord_id}> (${complaint.complainant_name || '—'})`, inline: true },
            { name: 'CitizenID',   value: complaint.is_anonymous ? '🕵️ Anônimo' : (complaint.citizen_id || '—'), inline: true },
