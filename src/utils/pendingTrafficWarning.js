// Armazenamento temporário do fluxo de registro de advertência de trânsito (2 etapas).
...
function set(guildId, userId, fields) {
    ...
    const existing = get(guildId, userId) || {
        condutorName: null, citizenId: null, plate: null, deadline: null,
        infractions: null, description: null,
    };
